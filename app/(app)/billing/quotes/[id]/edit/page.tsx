...
import { Rev19Builder, rowsFromLines, type Rev19Header } from '@/components/billing/rev19-builder'
...
export default async function EditQuotePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <Rev19Builder action={saveQuote.bind(null, id)} header={header} initialLines={rowsFromLines(d.lines)} customers={lists.customers} jobs={lists.jobs} rateCards={lists.rateCards} team={lists.team} currentUser={lists.team.find(t => t.id === userId) ?? null} />
    </div>
  )
}
